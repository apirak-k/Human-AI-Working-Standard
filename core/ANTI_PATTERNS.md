...
- **[Learned 2026-09-03]**: `Windows Directory Copy Duplication` ➔ **NEVER fallback to `cp -rf` directory copies on Windows when installing/linking skills. ALWAYS use native Windows NTFS Directory Junctions (`mklink /J`) to maintain 100% Zero Duplication and Single Source of Truth without requiring Administrator privileges.**
